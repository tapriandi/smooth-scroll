...
const scrollbar = Scrollbar.init(smooth, {
  damping: 0.05
});
  ...
  //   var prevScrollPos = scrollbar.scrollTop;
  //   var paddingTop = 100;
  //   scrollbar.addListener(function (status) {
  //     var currentScrollPos = scrollbar.scrollTop;
  //     console.log(currentScrollPos, prevScrollPos)

  //     if (prevScrollPos > currentScrollPos) {
  //       document.querySelector(".header-navigation_wrapper").classList.remove("hide");
  //     } else if (currentScrollPos > paddingTop) {
  //       document.querySelector(".header-navigation_wrapper").classList.add("hide");
  //     }
